...
const SUPPORTED_FORMATS = 'JPEG, PNG, WebP, AVIF, GIF, HEIC/HEIF, TIFF, SVG, MP4/MOV, MP3, FLAC, WAV, OGG, PDF, DOCX, XLSX, PPTX, ODT, ODS, ODP, EPUB';
...
test('minimal docs keep parser limits visible without extra planning files', async () => {
    ...
    assert.match(readme, /OGG cleaning supports single-stream Vorbis and Opus files/);
